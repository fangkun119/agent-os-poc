...
[Explore Examples](https://agents.md/#examples) [View on GitHub](https://github.com/agentsmd/agents.md)
...
[Warp](https://docs.warp.dev/knowledge-and-collaboration/rules#project-scoped-rules-1) [Gemini CLIfromGoogle](https://github.com/google-gemini/gemini-cli/blob/main/docs/get-started/configuration.md#available-settings-in-settingsjson) [Cursor](https://cursor.com/) [Phoenix](https://phoenix.new/) [Kilo Code](https://kilocode.ai/) [Zed](https://zed.dev/docs/ai/rules) [goose](https://github.com/block/goose) [Coding agentfromGitHub Copilot](https://gh.io/coding-agent-docs) [Factory](https://factory.ai/) [Augment Code](https://docs.augmentcode.com/cli/overview) [JulesfromGoogle](https://jules.google/) [![Ona logo](https://agents.md/logos/ona-light.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)![Ona logo](https://agents.md/logos/ona-dark.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)\\
\\
Ona](https://ona.com/) [Warp](https://docs.warp.dev/knowledge-and-collaboration/rules#project-scoped-rules-1) [Gemini CLIfromGoogle](https://github.com/google-gemini/gemini-cli/blob/main/docs/get-started/configuration.md#available-settings-in-settingsjson) [Cursor](https://cursor.com/) [Phoenix](https://phoenix.new/) [Kilo Code](https://kilocode.ai/) [Zed](https://zed.dev/docs/ai/rules) [goose](https://github.com/block/goose) [Coding agentfromGitHub Copilot](https://gh.io/coding-agent-docs) [Factory](https://factory.ai/) [Augment Code](https://docs.augmentcode.com/cli/overview) [JulesfromGoogle](https://jules.google/) [![Ona logo](https://agents.md/logos/ona-light.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)![Ona logo](https://agents.md/logos/ona-dark.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)\\
\\
Ona](https://ona.com/)

[Aider](https://aider.chat/docs/usage/conventions.html#always-load-conventions) [Autopilot & Coded AgentsfromUiPath](https://uipath.github.io/uipath-python) [![Windsurf logo](https://agents.md/logos/windsurf-light.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)![Windsurf logo](https://agents.md/logos/windsurf-dark.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)\\
\\
WindsurffromCognition](https://windsurf.com/) [Amp](https://ampcode.com/) [JuniefromJetBrains](https://jetbrains.com/junie) [RooCode](https://roocode.com/) [![VS Code logo](https://agents.md/logos/vscode-light.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)![VS Code logo](https://agents.md/logos/vscode-dark.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)\\
\\
VS Code](https://code.visualstudio.com/docs/editor/artificial-intelligence) [CodexfromOpenAI](https://openai.com/codex/) [Semgrep](https://semgrep.dev/) [![Devin logo](https://agents.md/logos/devin-light.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)![Devin logo](https://agents.md/logos/devin-dark.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)\\
\\
DevinfromCognition](https://devin.ai/) [opencode](https://opencode.ai/docs/rules/) [Aider](https://aider.chat/docs/usage/conventions.html#always-load-conventions) [Autopilot & Coded AgentsfromUiPath](https://uipath.github.io/uipath-python) [![Windsurf logo](https://agents.md/logos/windsurf-light.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)![Windsurf logo](https://agents.md/logos/windsurf-dark.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)\\
\\
WindsurffromCognition](https://windsurf.com/) [Amp](https://ampcode.com/) [JuniefromJetBrains](https://jetbrains.com/junie) [RooCode](https://roocode.com/) [![VS Code logo](https://agents.md/logos/vscode-light.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)![VS Code logo](https://agents.md/logos/vscode-dark.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)\\
\\
VS Code](https://code.visualstudio.com/docs/editor/artificial-intelligence) [CodexfromOpenAI](https://openai.com/codex/) [Semgrep](https://semgrep.dev/) [![Devin logo](https://agents.md/logos/devin-light.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)![Devin logo](https://agents.md/logos/devin-dark.svg?dpl=dpl_EHsMafo9jvoBjejout6bWTLDMDWm)\\
\\
DevinfromCognition](https://devin.ai/) [opencode](https://opencode.ai/docs/rules/)
...
Rust\\
\\
![Contributor avatar](https://avatars.githubusercontent.com/u/204937752?v=4)![Contributor avatar](https://avatars.githubusercontent.com/u/655869?v=4)![Contributor avatar](https://avatars.githubusercontent.com/u/230027070?v=4)\\
\+ 581](https://github.com/openai/codex/blob/-/AGENTS.md) [**apache/airflow** \\
\\
...
\+ 4571](https://github.com/apache/airflow/blob/-/AGENTS.md) [**temporalio/sdk-java** \\
\\
...
\+ 152](https://github.com/temporalio/sdk-java/blob/-/AGENTS.md) [**PlutoLang/Pluto** \\
\\
